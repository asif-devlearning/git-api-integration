...
#     for i, collaborator in enumerate(git_response.json()):
...
# # Check if the Excel file already exists and remove it if it does
# if os.path.exists(excel_file):
#     os.remove(excel_file)
#     print("----- Existing Excel file removed, will create a new one -----")

# # Read the CSV file into a DataFrame
# list_members_df = pd.read_csv(create_csv)
...
# }
# # Api Call to delete necessary members of the collaborators if necessary.
# add_member_username = input("Please enter the github username of the user you would like to add: ")

# # add_member_api_url = f"{list_collaborators}/{add_member_username} \-d '{{\"permission\":\"push\"}}'"
# # print(add_member_api_url)
# # Construct URL for adding a collaborator
# if add_member_username != None:
...
#     # add_member_response = requests.put(add_member_api_url, headers=headers)
